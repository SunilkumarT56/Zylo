            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                  <div className="w-48 bg-[#0A0A0A] border border-white/10 rounded-xl shadow-2xl p-1 overflow-hidden">
                    <div className="p-1">
                      <div className="px-3 py-2 text-sm text-zinc-300 hover:text-white hover:bg-white/5 rounded-md cursor-pointer transition-colors">
                        Product 1
                      </div>
                      <div className="px-3 py-2 text-sm text-zinc-300 hover:text-white hover:bg-white/5 rounded-md cursor-pointer transition-colors">
                        Product 2
